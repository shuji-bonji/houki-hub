...
graph TB
    subgraph Skill層["Skill 層（正典）"]
        SKILL["houki-research-skill v0.8.0<br/>error contract / citation / 業法独占規定<br/>workflow は問いの形で選ぶ（feasibility-check / tax-research）"]
    end
