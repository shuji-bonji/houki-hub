...
graph TB
    ...
    subgraph MCP層["MCP 層（SDK v2 / Node 22 / Biome に統一済み）"]
        ...
        NTA["houki-nta-mcp v0.18.0<br/>国税庁 / 14 tools<br/>Phase 1〜6 完了。v1.0 判定待ち"]
    end
