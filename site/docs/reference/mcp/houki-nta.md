...
description: "houki-nta-mcp v0.17.0 の全 14 ツールの引数・型・既定値（tools/list から自動生成）と実測の呼び出し例"
---
...
::: info
**v0.17.0** の `tools/list` から自動生成しました（14 ツール・2026-09-13）。手で編集しないでください。再生成は `node scripts/generate-reference.mjs` です。
:::
