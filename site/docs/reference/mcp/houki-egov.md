...
description: "houki-egov-mcp v0.14.1 の全 11 ツールの引数・型・既定値（tools/list から自動生成）と実測の呼び出し例"
---
...
::: info
**v0.14.1** の `tools/list` から自動生成しました（11 ツール・2026-09-20）。手で編集しないでください。再生成は `node scripts/generate-reference.mjs` です。
:::
